...
from src.pipeline.facepipeline import predict_attendance
import numpy as np
...
def teacher_screen_login():
    ...
    st.space()
    teacher_username = st.text_input("Enter username",placeholder="shayan tahseen",)
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name",placeholder="prof dk jha")
